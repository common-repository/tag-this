<?php
/*
Plugin Name: Tag This
Plugin URI: http://oinam.com/wordpress/plugins/tag-this/
Description: "Tag This" allow users to tag your Published Post. You can control, de-spam or even blacklist users. "Tag This" will be particularly useful if you've a big blog and it becomes difficult for you to be able to tag all your Posts in an effective way. This will even useful to older blogs which do not have tags in their old Posts (yes, tags were not so famous back then when we started blogging). An outcome of <a href="http://www.brajeshwar.com/" title="Brajeshwar">Brajeshwar</a>'s idea.
Version: 0.9.0
...
function tagthis_header() {
	...
	wp_register_script('tagthistemp', '/wp-content/plugins/tagthis/tagthistemp.js', false);
...
function create_tagthis_table() {
    ...
    update_option("tt_customcss","background-color:#D5D5D5;padding:10px 10px 10px 10px;");
